...
In order to support loading of multiple wallets in nvidiacash-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is nvidiacash.cpp.
...
Changes to nvidiacash.cpp
----------------------
nvidiacash.cpp is the entry point into nvidiacash-qt, and as such, will require some minor modifications to provide hooks for

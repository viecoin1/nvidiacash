...
This mechanism has been integrated into Bitcore-Node-Nvidiacash which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/nvidiacash-crypto/insight-api-nvidiacash#web-socket-api](https://github.com/nvidiacash-crypto/insight-api-nvidiacash#web-socket-api) 
* API: [https://github.com/nvidiacash-crypto/insight-api-nvidiacash#swifttx-transactions](https://github.com/nvidiacash-crypto/insight-api-nvidiacash#swifttx-transactions) 
...
By default, the Nvidiacash Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Nvidiacash Core daemon:

Contributing to Nvidiacash Core
============================

The Nvidiacash Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Nvidiacash Core project, and is not to be
confused with overall Nvidiacash Network Protocol consensus changes.

Whether a pull request is merged into Nvidiacash Core rests with the project merge
...
Patches that change Nvidiacash consensus rules are considerably more involved than
...
Where a patch set proposes to change the Nvidiacash consensus, it must have been
...
The project leader is the release manager for each Nvidiacash Core release.

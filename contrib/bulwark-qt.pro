...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/nvidiacash-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/nvidiacash-cli.cpp \
           src/nvidiacash-tx.cpp \
           src/nvidiacash.cpp \
           src/db.cpp \
           ...
           src/qt/nvidiacash.cpp \
           src/qt/nvidiacashstrings.cpp \
...
RESOURCES += src/qt/nvidiacash.qrc src/qt/nvidiacash_locale.qrc

TRANSLATIONS += src/qt/locale/nvidiacash_bg.ts \
                src/qt/locale/nvidiacash_de.ts \
                src/qt/locale/nvidiacash_en.ts \
                src/qt/locale/nvidiacash_es.ts \
                src/qt/locale/nvidiacash_fi.ts \
                src/qt/locale/nvidiacash_fr.ts \
                src/qt/locale/nvidiacash_it.ts \
                src/qt/locale/nvidiacash_ja.ts \
                src/qt/locale/nvidiacash_pl.ts \
                src/qt/locale/nvidiacash_pt.ts \
                src/qt/locale/nvidiacash_ru.ts \
                src/qt/locale/nvidiacash_sk.ts \
                src/qt/locale/nvidiacash_sv.ts \
                src/qt/locale/nvidiacash_vi.ts \
                src/qt/locale/nvidiacash_zh_CN.ts \
                src/qt/locale/nvidiacash_zh_TW.ts

...
public:
	...
	vAlertPubKey = ParseHex("04579f18934b3ef39094a9999e45506a1935662d0cd4e504d07beb53b8a1bfd78d81bee47e65119318397809420d5320e3c7b2aaae58580db48c38a4e6d4f0f919");
        nDefaultPort = 52543;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // Nvidiacash starting difficulty is 1 / 2^12
        nMaxReorganizationDepth = 100;
        nMinerThreads = 0;
        nTargetTimespan = 1 * 90; // Nvidiacash: 1.5 minutes
        nTargetSpacingSlowLaunch = 5 * 90;  // Nvidiacash: 7.5 minutes (Slow launch - Block 300)
	nTargetSpacing = 1 * 90; // Nvidiacash: 1.5min after block 300
	...
	hashGenesisBlock = genesis.GetHash();
		...
		vSeeds.push_back(CDNSSeedData("mempool.pw", "xnvseed.mempool.pw"));
        	vSeeds.push_back(CDNSSeedData("ssus.tech", "nvidiacash-dns-seed04.ssus.tech"));
...
public:
	...
	genesis.hashMerkleRoot == uint256("0x9873d80537d7bf6fcf097a6f9cd6d6a74d6a26ceda5b775a576665ffde76dd11");
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("nvidiacashcrypto.com", "test01.nvidiacashcrypto.com"));
	vSeeds.push_back(CDNSSeedData("nvidiacashcrypto.com", "test02.nvidiacashcrypto.com"));
	vSeeds.push_back(CDNSSeedData("nvidiacashcrypto.com", "test03.nvidiacashcrypto.com"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 65); // Testnet nvidiacash addresses start with 'T'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 12);  // Testnet nvidiacash script addresses start with '5' or '6'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet nvidiacash BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet nvidiacash BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet nvidiacash BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Nvidiacash: 1 day
        nTargetSpacing = 1 * 60;        // Nvidiacash: 1 minutes

...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
		...
		return false;
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Nvidiacash Core"),
     ...
     * override -datadir in the nvidiacash.conf file in the default data directory
     * (to be consistent with nvidiacashd behavior)
     */
    if (dataDir != getDefaultDataDirectory())

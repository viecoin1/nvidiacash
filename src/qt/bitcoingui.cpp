                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Nvidiacash Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Nvidiacash address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and nvidiacash: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Nvidiacash Core"), this);
    aboutAction->setStatusTip(tr("Show information about Nvidiacash Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Nvidiacash"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Nvidiacash addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Nvidiacash addresses"));
    ...
    openAction->setStatusTip(tr("Open a Nvidiacash: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Nvidiacash Core help message to get a list with possible Nvidiacash command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Nvidiacash Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Nvidiacash network", "", count));
}
...
{
    QString strTitle = tr("Nvidiacash Core"); // default title

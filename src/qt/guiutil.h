...
/** Utility functions used by the Nvidiacash Qt UI.
 */
namespace GUIUtil
{
...
// Render Nvidiacash addresses in monospace font
...
// Parse "nvidiacash:" URI into recipient object, return true on successful parsing

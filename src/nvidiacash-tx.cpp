...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Nvidiacash Core nvidiacash-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  nvidiacash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded nvidiacash transaction") + "\n" +
                               "  nvidiacash-tx [options] -create [commands]   " + _("Create hex-encoded nvidiacash transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded nvidiacash transaction

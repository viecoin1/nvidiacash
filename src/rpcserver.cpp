...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Nvidiacash server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Nvidiacash server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Pivx features */
        {"nvidiacash", "masternode", &masternode, true, true, false},
        {"nvidiacash", "listmasternodes", &listmasternodes, true, true, false},
        {"nvidiacash", "getmasternodecount", &getmasternodecount, true, true, false},
        {"nvidiacash", "masternodeconnect", &masternodeconnect, true, true, false},
        {"nvidiacash", "masternodecurrent", &masternodecurrent, true, true, false},
        {"nvidiacash", "masternodedebug", &masternodedebug, true, true, false},
        {"nvidiacash", "startmasternode", &startmasternode, true, true, false},
        {"nvidiacash", "createmasternodekey", &createmasternodekey, true, true, false},
        {"nvidiacash", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"nvidiacash", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"nvidiacash", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"nvidiacash", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"nvidiacash", "getmasternodescores", &getmasternodescores, true, true, false},
        {"nvidiacash", "mnbudget", &mnbudget, true, true, false},
        {"nvidiacash", "preparebudget", &preparebudget, true, true, false},
        {"nvidiacash", "submitbudget", &submitbudget, true, true, false},
        {"nvidiacash", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"nvidiacash", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"nvidiacash", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"nvidiacash", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"nvidiacash", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"nvidiacash", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"nvidiacash", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"nvidiacash", "checkbudgets", &checkbudgets, true, true, false},
        {"nvidiacash", "mnsync", &mnsync, true, true, false},
        {"nvidiacash", "spork", &spork, true, true, false},
        {"nvidiacash", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"nvidiacash", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use nvidiacashd, or the -server option to nvidiacash-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               "It is recommended you use the following random password:\n"
                                               "rpcuser=nvidiacashrpc\n"
                                               "rpcpassword=%s\n"
...
{
    return "> nvidiacash-cli " + methodname + " " + args + "\n";
}
